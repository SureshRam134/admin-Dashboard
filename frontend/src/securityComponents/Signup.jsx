                ...
                <div className='lg:pe-2 w-full md:w-[250px] lg:w-[280px] xl:w-[330px] mx-auto items-center '>
                    ...
                    >
                        ...
                        <div className='relative flex flex-col'>
                            ...
                            {signUserErr && <span className='absolute text-primary-Err text-xs top-[48px] md:text-[11px] md:top-[40px] xl:top-[48px]'>{signUserErr.name}</span>}
                        </div>
                        <div className='relative flex flex-col'>
                            <input
                                className='w-full text-[14.22px] px-[15px] py-[13px] mb-[20px] md:text-[13px] md:px-[12px] md:py-[10px] md:mb-[20px]  xl:text-[14.22px] xl:px-[15px] xl:py-[13px] xl:mb-[20px] rounded-lg border-[1px] border-secondary-gray bg-secondary-light text-secondary-light-gray font-lato outline-none focus:ring-1 focus:ring-blue-500'
                                ...
                                onChange={inputHandleFun} />
                            {signUserErr && <span className='absolute text-primary-Err text-xs top-[48px] md:text-[11px] md:top-[40px] xl:top-[48px]'>{signUserErr.email}</span>}
                        </div>
                        <div className='relative flex flex-col'>
                            <input
                            ...
                            />
                            {!hiddenPass ?
                                <span className='absolute right-[11%] top-[24%] md:top-[22%] xl:top-[25%] '>
                            ...
                            {signUserErr && <span className='absolute text-primary-Err text-xs top-[48px] md:top-[40px] md:text-[11px] md:top-[40px] xl:top-[48px]'>{signUserErr.password}</span>}
                        </div>

                        <p
                            className='hidden md:block text-[12px] lg:text-[12.64px] text-primary-light-gray font-lato mb-[20px]'
