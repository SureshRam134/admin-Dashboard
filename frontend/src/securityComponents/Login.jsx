                ...
                <div className='lg:pe-2 w-full md:w-[270px] lg:w-[344px] lg:mx-auto items-center '>
                    ...
                    >
                        <div className='relative flex flex-col'>
                            ...
                            {logErr && <span className='absolute text-primary-Err text-xs top-[83px]'>{logErr.email}</span>}
                        </div>
                        ...
                        <div className='relative flex flex-col'>
                            ...
                            >Password</label>
                            <input
                                className=' w-full text-[14.22px] px-[15px] py-[13px] mb-[14px] rounded-lg border-[1px] border-secondary-gray bg-secondary-light text-secondary-light-gray font-lato outline-none focus:ring-1 focus:ring-blue-500'
                                id='password'
                            ...
                            {!hiddenPass ?
                                <span className='absolute right-[11%] top-[53%] '>
                            ...
                            {logErr && <span className='absolute text-primary-Err text-xs top-[83px]'>{logErr.password}</span>}
                        </div>
